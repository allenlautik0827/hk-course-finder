...
def format_course(c):
    ...
    def fmt_yr(v):
        """将年数格式化为整数（去掉小数点），如 1.0 → '1'，1.5 → '1.5'"""
        if v is None:
            return '-'
    ...
    return {
        ...
        'degree': c.get('degree', ''),
        'teaching_format': c.get('teaching_format', '') or '面授',
        ...
        'chinese_req': bool(int(c.get('chinese_req', 0) or 0)),
        'english_req': bool(int(c.get('english_req', 0) or 0)),
